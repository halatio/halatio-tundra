"""Oracle connector using Polars + ConnectorX"""
...
class OracleConnector(BaseConnector):
    """Production-grade Oracle connector"""
    ...
    def _build_connection_string(self) -> str:
        ...
        return (
            f"oracle://{self.credentials['username']}:{self.credentials['password']}"
            f"@{self.credentials['host']}:{self.credentials.get('port', 1521)}"
    ...
    async def extract_to_parquet(
        ...
        **kwargs
        ...
        """
        Extract Oracle data to Parquet using ConnectorX
        ...
        try:
            ...
            logger.info(f"Extracting Oracle data with query: {query[:100]}...")
            ...
            logger.error(f"Oracle extraction failed: {str(e)}")
            raise
    ...
    async def test_connection(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Oracle uses SELECT 1 FROM DUAL instead of SELECT 1
            def _test_sync():
